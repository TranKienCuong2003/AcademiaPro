    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="/public/index.php">
                <img src="https://cdn-icons-png.flaticon.com/512/3595/3595030.png" alt="Logo" style="height: 40px;">
                AcademiaPro
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="/app/views/instructors/index.php">Quản lý Giảng viên</a></li>
                    <li class="nav-item"><a class="nav-link" href="/app/views/students/index.php">Quản lý Sinh viên</a></li>
                    <li class="nav-item"><a class="nav-link" href="/app/views/courses/index.php">Quản lý Môn học</a></li>
                    <li class="nav-item"><a class="nav-link" href="/app/views/grade/index.php">Quản lý Điểm thi</a></li>
                    <?php if (isset($_SESSION['username'])): ?>
                        <li class="nav-item">
                            <span class="navbar-text">Xin chào, <span class="navbar-text-user"><?php echo htmlspecialchars($_SESSION['username']); ?></span></span>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="/app/views/auth/logout.php">Đăng xuất</a></li>
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link" href="/app/views/auth/login.php">Đăng nhập</a></li>
                        <li class="nav-item"><a class="nav-link" href="/app/views/auth/register.php">Đăng ký</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
        ...
        <div class="container p-4">
            <div class="row">
                <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                    <h5 class="text-uppercase">AcademiaPro</h5>
                    <p class="footer-description">Hệ thống quản lý giáo dục trực tuyến giúp bạn quản lý thông tin một cách dễ dàng và hiệu quả.</p>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                    <h5 class="text-uppercase">Liên kết nhanh</h5>
                    <ul class="list-unstyled">
                        <li><a href="/app/views/instructors/index.php">Giảng viên</a></li>
                        <li><a href="/app/views/students/index.php">Sinh viên</a></li>
                        <li><a href="/app/views/courses/index.php">Môn học</a></li>
                        <li><a href="/app/views/grade/index.php">Điểm thi</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
